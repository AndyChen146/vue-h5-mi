<template>
    <div class="app-init gouwuche-page">
        ...
        <div class="scroll-box gouwu-view">
            <div class="shop-wrap" v-if="shopCartListLength == 0">
                <img src="../../assets/icon/empty-car.png" @click="$router.openPage('/')" alt="">
            </div>
                ...
                <div class="shop-item clear" v-for="(target,index) in shopCarList" :key="index">
                    ...
                    <div class="function-box fr">
                        ...
                        <div class="button-group">
                            ...
                            <span class="iconfont icon-del delete" @click="deteleShop(target)"></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="shopCar-footer">
            <div class="item money">
                <p>共3件<span>金额</span></p>
                <p><span class="mm">3000</span>元</p>
            </div>
...
export default {
    ...
    computed: {
        ...
        getAllMoney() {
            var n = 0;
            for(var i in this.shopCarList) {
                n += this.shopCarList[i].money * this.shopCarList.length
            }
            return n
        }
    }
...
<style style="text/sass" lang="scss">
@import "../../assets/public/util";
.gouwuche-page{
    .gouwu-view{
        position: absolute;
        width: 100%;
